...
# Configure Jupyter to use Jupytext
...
c.ContentsManager.preferred_jupytext_formats_save = "py:hydrogen"
...
# https://github.com/mwouts/jupytext/blob/master/README.md
#------------------------------------------------------------------------------
